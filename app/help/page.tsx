  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 items-center justify-center p-8">
      <div className="bg-white rounded-[2rem] p-12 shadow-sm border border-slate-100 max-w-2xl w-full text-center flex flex-col items-center">
        ...
        <h1 className="text-3xl font-bold text-slate-800 tracking-tight mb-4">Help Center</h1>
        <p className="text-slate-500 max-w-md text-lg">
          The help center is currently part of the mockup. Documentation, tutorials, and support tickets will be accessible from here.
        </p>
      </div>
    </div>
  );
